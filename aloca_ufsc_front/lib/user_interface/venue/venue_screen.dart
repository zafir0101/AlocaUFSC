...
class _VenueScreenState extends State<VenueScreen> {
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              TextField(controller: locationController, decoration: const InputDecoration(labelText: 'Localização')),
              TextField(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Controle de Espaços Físicos')),
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('${item.location} | Capacity: ${item.capacity}'),
                  trailing: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      IconButton(
